...
\newcommand{\location}[1]{\par \begin{footnotesize} [\textsc{#1}] \end{footnotesize} \par}
\newcommand{\badexpl}[1]{\par \begin{small} \textcolor{color_example_bad}{[$\rightarrow$ #1]} \end{small} \par}
\newcommand{\goodexpl}[1]{\par \begin{small} \textcolor{color_guideline}{[$\rightarrow$ #1]} \end{small} \par}

% rule for fake algorithm environments
\newcommand{\algruletop}{\noindent\rule{\textwidth}{0.2pt}}
\newcommand{\algrulebottom}{\noindent\rule{\textwidth}{0.2pt} \vspace{-\baselineskip}}

% indentation in tcolorbox
\newcommand{\tcolorboxindent}{\phantom{~~~}}

% further reading: paragraph + reference
\newcommand{\parwithcite}[2]{%
    \noindent
    \ignorespaces
    #2
    \begin{itemize}
