...
\goodexample[{\cite[Abstract, Sec.~III.]{Wetzlinger2023TAC}}]{
    ...
    \end{equation*}
    \goodexpl{The two links---concerning the manual vs.\ automated tuning of algorithm parameters and respecting a maximum error---become apparent through the use of similar wording.}
}
