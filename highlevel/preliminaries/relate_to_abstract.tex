...
\guideline[g:preliminaries:abstract]
    {Directly relate the problem statement to the abstract.}
...
\goodexample[{\cite[Abstract \& Sec.~III.]{Wetzlinger2023TAC}}]{
    ...
    \end{equation*}
    \goodexpl{The two links---concerning manual vs.\ automated tuning of algorithm parameters and respecting a maximum error---become apparent through the use of similar wording.}
}

\noindent
A clear link between the abstract and the problem statement is best achieved by using similar wording.
