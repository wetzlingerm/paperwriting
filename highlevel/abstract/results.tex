...
\goodexample[{\cite[Adapted from Abstract]{Wetzlinger2024CSL}}]{
    A comparison with state-of-the-art approaches on several benchmarks demonstrates the advantages of our approach regarding accuracy and computation time.
}
