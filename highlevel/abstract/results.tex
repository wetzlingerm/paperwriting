...
\goodexample[{Adapted from \cite[Abstract]{Wetzlinger2024CSL}}]{
...
This part should mention the datasets used for the evaluation, which are either custom examples or well-known benchmarks, and the approaches against which the proposed approach is compared, including metrics like accuracy or computation time.
