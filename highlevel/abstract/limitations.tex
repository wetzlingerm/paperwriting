...
\goodexample[{\cite[Abstract]{Wetzlinger2024CSL}}]{
    While the majority of state-of-the-art approaches for nonlinear systems obtain an inner approximation via first computing an outer approximation of the reachable set, (...)
}
