...
\goodbadexample[{\cite[Title]{Wetzlinger2024CSL}}]{
    ...
    \badexpl{The word ``computing'' does not add much value as most papers are concerned with computation, the term ``nonlinear dynamical systems'' is wordy yet inaccurate; curcially, the paper's unique selling point is missing, such as the core idea of the algorithm.}
}{
