...
\goodbadexample[{\cite[Sec.~III.B.]{Wetzlinger2024CSL}}]{
    ...
    \badexpl{There are no transitions between the paragraphs.}
}{
...
Use clear transitions---either explicit cues referencing some specific text element or implicit links that refer back to the preceding topic in the opening sentence.
