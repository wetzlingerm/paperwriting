...
\goodexample[{Adapted from \cite[Sec. 3.3 \& Fig.~1]{Wetzlinger2024ARCH1}}]{
    ...
    \IfFileExists{build/figure_mainbody.pdf}{
        \includegraphics{build/figure_mainbody.pdf}
    }{
...
When illustrating workflows, it is often helpful to break down each step into separate subfigures and letting the full process emerge from the sequence.
Such figures can be dense as their purpose is to convey a complex overarching idea clearly yet accurately---precise labeling is essential to achieve this.
