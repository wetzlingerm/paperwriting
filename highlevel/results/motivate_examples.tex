...
Instead, explain why each example was chosen:
You might use a simple example to illustrate a core concept, a more intricate one to demonstrate scalability, or a challenging benchmark for a comparison with the state of the art.
