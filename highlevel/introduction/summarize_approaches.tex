...
\goodbadexample[{\cite[Sec.~I.]{Wetzlinger2024CSL}}]{
    ...
    \badexpl{Approaches are only mentioned and lack a proper summary.}
}{
...
\noindent
When providing readers with an overview of the state of the art, it is not enough to merely list approaches by name.
Rather, briefly summarize key properties such as the main idea of each approach, its properties across different metrics, and its potential applicability in various domains.
