...
\guideline[g:introduction:relatedwork_structure]
    {Organize the related work into paragraphs of separate subtopics.}
...
\noindent
Related work often divides naturally into subtopics with distinct perspectives on the research question.
Provide a clear distinction between subtopics by dedicating one paragraph to each subtopic, and let the opening phrase of the first sentence act as an implicit header.
If the discussion of individual subtopics becomes extensive, use subsections instead of paragraphs to maintain clarity.
