...
First, by integrating the structural outline into the contributions, which is recommendable for shorter works or a more compact list of contributions.
Second, by using a separate paragraph, which is often the last paragraph of the introduction, or even a separate subsection if the introduction has subsections.
For papers of short length, i.e., 6 pages or less, it can be advisable to omit the structure outline and use the space elsewhere.
