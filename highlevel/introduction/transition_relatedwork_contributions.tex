...
\noindent
Readers must clearly understand which problem the paper addresses, so the contributions should be explicitly tied to the limitations of prior work.
Each contribution should correspond directly to a specific shortcoming in the state of the art, using consistent wording or even restating the limitation when appropriate.
