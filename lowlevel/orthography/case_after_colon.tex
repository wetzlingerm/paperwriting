...
\guideline[g:orthography:case_after_colon]
    {After a colon, use uppercase when a full sentence follows, use lowercase when a list or explanation follows.}
...
\noindent
Note that this guideline only applies to running text, not to headings or captions.
In particular, it also applies to text after bullet points in lists.
