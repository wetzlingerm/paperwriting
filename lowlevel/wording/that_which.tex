...
\guideline[g:wording:that_which]
    {Use ``that'' for necessary details, ``which'' for supplementary details.}
...
\noindent
As a test, one can try removing the clause starting with ``that'' or ``which'' and check whether the sentence remains complete.
