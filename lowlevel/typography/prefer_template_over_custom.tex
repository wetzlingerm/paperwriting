...
\noindent
The formatting options provided by \LaTeX{}---such as headings, paragraphs, lists, and special environments for algorithms, tables, or figures---offer sufficient expressivity, eliminating the need for custom formatting.
There are multiple ways to convert custom formatting into built-in formatting by using transitional phrases to establish a clear relationship between parts of the text, by using a more rigid structural element that can be referenced, or by using an explanatory figure for more complex relationships.
