...
\guideline[g:typography:delimiters_size]
    {Adjust the size of delimiters.}
...
\noindent
Delimiters of proper size provide the necessary hierarchical structure for the mathematical expression.
Common delimiters include parentheses, brackets, braces, vertical bars, and angle brackets.
