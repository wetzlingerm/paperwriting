...
\goodexample[Adapted from {\cite[Sec.~2]{Wetzlinger2021HSCC}}]{
    ...
    \input{data/algorithm_operators.tex}
}

\noindent
Since pseudocode aims to be concise, it is often better to use named operations rather than detailing every computation, especially for standard tasks like sorting.
