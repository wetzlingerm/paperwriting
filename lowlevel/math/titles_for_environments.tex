...
\noindent
A title sets a frame for the content of the environment, which provides understanding on a higher level.
This lets the reader integrate the information more easily into the flow of the running text.
